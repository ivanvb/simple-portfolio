        ...
        <section className="container pt-4 md:pt-8">
            <div className="flex flex-col md:flex-row md:space-x-8 lg:space-x-16">
                ...
                <div className="w-full md:w-1/2 mt-4 md:mt-0">
                    <h1 className="text-2xl md:text-3xl font-extrabold">A very Interesting Art</h1>
                    ...
                    <div className="flex flex-col space-y-4 py-2 md:py-4 opacity-70">
                        <p>
                            ...
                            pariatur enim dolore aliqua. Duis nulla fugiat magna incididunt ipsum
                            eiusmod occaecat enim occaecat nisi minim aliqua ipsum magna. In aliqua
                            cupidatat aliquip dolor consequat Lorem non aliqua non labore laborum.
                        </p>
                        <p>
                            Velit ipsum id cupidatat in ipsum nostrud aute ullamco aliquip tempor
                            excepteur aute in amet.
                        </p>
                    </div>
                </div>
            </div>
